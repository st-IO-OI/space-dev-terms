...
ちなみに、国際宇宙ステーションは地球低軌道（LEO）上に建設されています。  
長期間の運用が可能になるよう再補給・修理・電源供給・温度制御といったシステムが整備されています。  

今後は月探査や火星探査を見据えた新たな宇宙ステーションが建設される可能性もあります。  
これらは宇宙探査における中継基地としての役割が期待されています。  
