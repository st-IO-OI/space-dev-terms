...
title: プライバシーポリシー
slug: /privacy-policy
description: 宇宙開発ポータルのプライバシーポリシー
---
...
<Head>
  <script type="application/ld+json">
    {`{
      ...
      "description": "宇宙開発ポータルのプライバシーポリシー",
      "url": "https://space-dev-terms.pages.dev/docs/privacy-policy"
    }`}
  </script>
</Head>
...
当サイト「宇宙開発ポータル」（ https://space-dev-terms.pages.dev/ 、以下「当サイト」）では、訪問者のプライバシー保護を最優先に考え、関連する法令を遵守した適切な情報管理に努めます。
