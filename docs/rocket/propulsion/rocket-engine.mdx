...
<Head>
  <script type="application/ld+json">
    {`{
      ...
      "termCode": "rocket/propulsion/rocket-engine",
      "description": "推進剤を燃焼・噴射して自ら推力を生み出す，閉じたシステムの推進装置のことであるロケットエンジンの意味・定義・内容について解説します．",
      "url": "https://space-dev-terms.pages.dev/docs/rocket/propulsion/rocket-engine"
    }`}
  </script>
</Head>
